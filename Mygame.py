...
gametitle="Journey - an interantive story game"
system("mode 110,30")
...
cls()
print("Journey - an interantive story game")

def Intro():
    print("")
    print("In this adventure, you are the hero.")
    print("Your choices, skills, and a bit of luky, will influence the outcome of the game.")
    print("")
...
def create_character_skill_sheet():
    ...
    - Magic, which you will use whenever you need to cast a spell or use/inspect a megical item or place
    ...
    You will shortly be abler to increase your skills by rolling a 6-face die.
...
def modify_skills():
    ...
    print("To modify your skills, roll a six face die for each of your skills, and the game will add them")
...
def skill_check():
    cls()
    print("A giant rock falls from the ceiling, rol l a die to see if you can dodge it... or you will be you will be crashed by it!")
    roll=randint(1,6)
    print("You rolled: "+str(roll))
    if roll+character_dexterity > 10:
        print ("""
            You dodge stone and survivel Danger is not over though..
            The strange noise in the darkness contninues, and it feels a lot closer now..""")
        input("Press Enter to continue...")
        combat()
    else:
